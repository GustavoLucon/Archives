...
public class TelaAplicação extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	double valor = Double.parseDouble(JOptionPane.showInputDialog("Digite o valor da ação"));
    	...
    	int duracao = Integer.parseInt(JOptionPane.showInputDialog("Digite a duração do mesmo(em meses)"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	System.out.print("Funçao desativada");
    }
