...
//************ATRIBUTOS***************/
	protected Node raiz; // no raiz da arvore
	protected Node pt; // no de percurso
	protected Node aux;// no auxiliar de percurso (guarda o ultimo no acessado)
...
/*========================================================================================*/
	...
	public boolean eInterno(Node n){
...
/*========================================================================================*/
	...
	public boolean eExterno(Node n){
		if (n.dir == null && n.esq == null)
			return true;
		else return false;
	}
...
/*========================================================================================*/
	...
	private int somaTamanho(Node p){
...
/*========================================================================================*/
	...
	public int profundidade(Node x){
		int prof = 0;
		Node p = x;
		while(p.pai != null){
			prof++;
...
/*========================================================================================*/
	...
	private int max(Node p,int valor){
			int x = valor;
...
/*========================================================================================*/
	 ...
	 * para recursao) na representacao de parenteses aninhados*/
	private String exibirArvoreInOrdem(Node p){
...
/*========================================================================================*/
	 ...
	 * para recursao) na representacao de parenteses aninhados*/
	private String exibirArvorePosOrdem(Node p){
