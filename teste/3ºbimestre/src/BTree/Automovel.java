...
public class Automovel<T extends Comparable<T>> {

    private static Automovel<Integer> tree = new Automovel<Integer>();
    private static Automovel<Integer> tree2 = new Automovel<Integer>();
